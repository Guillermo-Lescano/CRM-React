import { Outlet, Link, useLocation } from "react-router-dom"   //importamos el outlet, actua como un placeHolder o como un contenedor dinamico
  ...
  return (
    <div className="md:flex md:min-h-screen">
        <aside className="md:w-1/4 bg-blue-900 px-5 py-10">
          <h2 className="text-rxl font-black text-center text-white">CRM - Cliente</h2>
          <nav className="mt-10">
            <Link 
